...
- [Grew even stronger relationships](#grew-even-stronger-relationships)
- [Executed the vision for my team](#executed-the-vision-for-my-team)
- [Improved our finances](#improved-our-finances)
- [Read and learned A LOT](#read-and-learned-a-lot)
- [Launched a new podcast](#launched-a-new-podcast)
- [Improved my productivity](#improved-my-productivity)
- [Managed to get strong(er)](#managed-to-get-stronger)
- [Dove deeper into machine learning](#dove-deeper-into-machine-learning)
- [Started two businesses](#started-two-businesses)
- [Open-sourced two projects](#open-sourced-two-projects)
...
This relatively small change has led to an even stronger bond between us. It was by no means weak before but it goes to prove the power of wisely and consistently spending your finite resources (time, in this case); a concrete case of the power of [The Slight Edge](https://www.seastone.io/the-slight-edge/).
...
This past summer, I read [The Engineering Executive's Primer](https://www.seastone.io/the-engineering-executives-primer/), by Will Larson, and realized that his ideas about creating engineering strategies could take this vision initiative to a whole new level. So that's what we're working on for 2025!
...
![I finished 67 books in 2024](https://www.seastone.io/content/images/2024/12/annual-number-of-books.png)
...
![I read 14 718 pages in 2024](https://www.seastone.io/content/images/2024/12/annual-number-of-pages.png)
...
![Distribution of different genres I read during 2024](https://www.seastone.io/content/images/2024/12/reading-breakdown-2024.png)
...
Thus, this year, I made it happen: say hello to [The Open Shelf podcast](https://linkedin.com/company/the-open-shelf).

![Cover for the intro episode of The Open Shelf](https://www.seastone.io/content/images/2025/01/introducing-the-open-shelf.png)
...
Check us out on [Spotify](https://open.spotify.com/show/5mHNraZyWVlrpjNlOMTBT7?si=2dc72965e5564114) or [YouTube](https://www.youtube.com/@TheOpenShelf).
...
Two of my biggest upgrades to this life framework of mine came after first reading [How to Take Smart Notes](https://www.seastone.io/how-to-take-smart-notes/), which prompted me to start externalizing my knowledge, and then reading [Getting Things Done](https://www.seastone.io/getting-things-done/), which helped me structure how I prioritize my time.

2024 saw another big evolution, after reading [Building a Second Brain](https://www.seastone.io/building-a-second-brain/) and [The PARA Method](https://www.seastone.io/the-para-method/), both by Thiago Forte.
...
If the book [Essentialism](https://www.seastone.io/essentialism/) taught me anything, it's that you have to turn down a lot of good options in order to really double down on and benefit from the one great option.
...
Concretely, I added [pandas](https://pandas.pydata.org/) and [sklearn](https://scikit-learn.org/) to my toolbox. I haven't touched Python is over a decade but found a superpower in [Gemini](https://gemini.google.com/) for [Google Colab](https://colab.research.google.com/), which helped me learn the two ML libs much, much faster than I would otherwise have managed.

Speaking of generative AI, I also had a lot of fun with [Fooocus](https://github.com/lllyasviel/Fooocus) this year.

### Started two businesses

Armed with the realization that I need something more than salary and investments to reach my financial goals and spurred on by entering my fifth decade on this earth, I began to seriously [build a business](https://www.seastone.io/building-a-business/).

I won't repeat the details of this journey but suffice to say that it's been anything but straight, first leading in the direction of resuscitating [Athlegan](https://www.athlegan.com/), my online fitness coaching for vegans, and then towards [Gymbrain](https://www.gymbrain.pro/crossfit), an AI-based tool for gym owners.
...
All those books have helped me focus on the sequence of 1) identifying a group of potential customers, 2) [figuring out a joint problem of theirs](https://www.seastone.io/looking-for-problems/), 3) solving that specific problem without unnecessary bloat, and 4) productizing it all as integrated offers, marketing, and pricing.
...
- [csvmerge](https://github.com/tobiassjosten/csvmerge) is a terminal-based tool to join two or more CSV data sources.
- [go-truecoach](https://github.com/tobiassjosten/go-truecoach) is a library for integrating with the (unofficial) TrueCoach API.
