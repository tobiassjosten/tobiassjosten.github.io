...
I began writing publically back in 2010 when I first published an article on the pros and cons of using the `www` subdomain. While my writing has continued virtually uninterrupted since then, it has changed profoundly during this time.

<!--more-->

For one, I've become a vastly better writer (at least my mom says so). Doing anything consistently for more than a decade will inevitably lead to improvements. More interestingly, however, is how my reason for and thinking about writing has changed over the years.
...
While it might initially feel discouraging – you just want to hit publish and get on with your day – there's a lot of value to be harvested from these realizations. As [Marcus Aurelius wrote](/books/meditations/), over two millennia ago:
...
The task is very simple: 1) [subscribe to my newsletter](#/portal/) and 2) reply to the question I send you in the intro email. That's it!
