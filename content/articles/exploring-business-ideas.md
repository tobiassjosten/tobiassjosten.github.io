...
What I like about reading a series of books on the same subject is that you get to see the important fundamentals repeated between them and it becomes easier to identify the less important fluff.
...
![10'000 in assets outgrowing 20'000 in liabilities after eight years of 10% year-on-year growth](https://www.seastone.io/content/images/2024/06/assets-vs-liabilities-10-years-1.png)
*10'000 in assets vs 20'000 in liabilities over ten years (10% yield per year).*

And if we crank that up to twenty years?

### Twenty years with assets vs liabilities

![10'000 in assets grows to over 60'000 in 20 years of 10% year-on-year yield](https://www.seastone.io/content/images/2024/06/assets-vs-liabilities-20-years.png)
*10'000 in assets vs 20'000 in liabilities over twenty years (10% yield per year).*
...
{{< article "engineering-my-familys-spending" >}}
...
After A LOT of consideration, over many months, I finally decided to proceed with [Athlegan](https://www.athlegan.com/), my old online fitness coaching. It had been dormant since I got promoted to manager over two years ago and I was seriously itching to get back at it.
...
I've also long been interested in artificial intelligence, having competed in Google AI challenge in 2010 and 2011, and implemented many different AI algorithms for [MUD gaming](https://nogfx.org/) (like path finding, pattern detection, diffusion).

This year I was planning on taking things further.

That's when I started talking to my brother, who owns [two boutique gyms](https://www.flexibelfriskvardhalsa.se/). They've been growing steadily for years but we wondered if they could grow even faster with the right kind of insights and specialized business intelligence.
